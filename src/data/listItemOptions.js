...
const spaceProject = [
  {
    file: "space-splash.png",
    string: "User interface replicating Figma mockup from designer.",
  },
  {
    file: "space-dash.png",
    string:
      "Dash-board view. Visible space objects on the right, filters on the left.",
  },
  {
    file: "space-iss-card.png",
    string:
      "International Space Station API is used to calculate its visibility based on the user's location.",
  },
];

export { tabiVenues, spaceProject };
